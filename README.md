...
Clone this repo, build it, and make sure it runs.
...
This tech test uses [Create React App](https://github.com/facebook/create-react-app) as a starting point. Please feel free to add any other packages you require to complete your tasks.
